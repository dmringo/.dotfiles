...
;; Author: 0rdy <mail@0rdy.com> [modified by me!]
...
(deftheme my-kaolin "A [modified] dark jade theme")

(defgroup my-kaolin-theme nil
  "Kaolin theme properties"
  :prefix "my-kaolin-"
  :group 'faces)

(defcustom my-kaolin-bold t
  "If nil, disable the bold style."
  :group 'my-kaolin-theme)

(defcustom my-kaolin-italic t
  "If nil, disable the italic style."
  :group 'my-kaolin-theme)

(defcustom my-kaolin-underline t
  "If nil, disable the underline style."
  :group 'my-kaolin-theme)

(defface my-kaolin-boolean nil
...
(let ((class '((class color) (min-colors 89)))
      ...
      ;; Face options
      (bold         my-kaolin-bold)
      (italic       my-kaolin-italic)
      (underline    my-kaolin-underline))
  ...
  (let* ((fg1  white)
    ...
    (custom-theme-set-faces
     ...
     ;; Kaolin faces
     `(my-kaolin-boolean ((,class (:foreground ,bool))))
     ...
     ;; Whitespace
     `(whitespace-empty            ((t (:foreground ,err))))
     `(whitespace-line             ((t (:foreground ,black :background ,warning))))
...
(provide-theme 'my-kaolin)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; my-kaolin-theme.el ends here
