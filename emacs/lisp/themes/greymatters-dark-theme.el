;;; greymatters-dark-theme.el --- Theme 
  ...
  (custom-theme-set-faces
   ...
   `(mode-line
     ((,class (:box (:line-width 1 :color nil)
                    :bold t :foreground ,fg4 :background ,bg2))))
   `(mode-line-inactive
   ...
   `(org-agenda-structure
     ((,class (:weight bold :foreground ,fg3 :box (:color ,fg4) :background ,bg3))))
   ...
   `(helm-source-header
     ((,class (:foreground ,keyword :background ,bg1 :underline nil :weight bold))))
...
(provide-theme 'greymatters-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; greymatters-dark-theme.el ends here
